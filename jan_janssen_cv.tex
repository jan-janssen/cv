...
\Year{2023} &
  ...
  \newline • Computing Hardware Funding: USD 13k 
  \\ &
...
Google Scholar, 04/26: Citations: 501

\begin{EntriesTable}
\Year{2026}  &
  S. Brinckmann, S. Menon, R. Röske, J. Steinhülb, M. Selzer, \Me, T. Hickel, R. Schwaiger and J. Neugebauer.
  ...
  \\
  ~ &
  Sk Md A.A. Alvi, B. Vela, V. Attari, \Me, D. Perez, D. Allaire, and R. Arróyave. 
  ...
  \DOI{10.1038/s41524-026-01981-7}.
  Citations:~2
  \\
  ~ &
  M. Stricker, L. Banko, N. Sarazin, N. Siemer, \Me, L. Zhang, {\JN} and A. Ludwig. Computationally accelerated experimental materials characterization - drawing inspiration from high-throughput simulation workflows. \emph{npj Computational Materials}.
  \DOI{10.1038/s41524-025-01919-5}.
  Citations:~6
  \\
  ~ &
  I. Baghishov, \Me, G. Henkelman and D. Perez.
  Application-specific Machine-Learned Interatomic Potentials: Exploring the Trade-off Between DFT Convergence, MLIP Expressivity, and Computational Cost. \emph{Digital Discovery}.
  \DOI{10.1039/D5DD00294J}.
  Citations:~1
  \GitHub{IlgarBaghishov/DFTprecisionMLIP}
  \\
\Year{2025}  &
  Sk Md A.A. Alvi, M. Mulukutla, N. Flores, D. Khatamsaz, \Me, D. Perez, D. Allaire, V. Attari and R. Arróyave.
  Accurate and uncertainty-aware multi-task prediction of HEA properties using prior-guided deep Gaussian processes. \emph{npj Computational Materials}.
  \DOI{10.1038/s41524-025-01811-2}.
  Citations:~2
  \GitHub{sheikhahnaf/DGP\_with\_EncoderDecoderPrior}
  \\
  ~ &
  \Me, J. George, J. Geiger, M. Bercx, X. Wang, C. Ertural, J. Schaarschmidt, A.M. Ganose, G. Pizzi, T. Hickel and \JN.
  A Python workflow definition for computational materials design. \emph{Digital Discovery}.
  \DOI{10.1039/D5DD00231A}.
  Citations:~5
  \GitHub{pythonworkflow/python-workflow-definition}
  \\
  ~ &
  Y. Zimmermann, A. Bazgir, A. Al-Feghali, M. Ansari, L.C. Brinson, Y. Chiang, D. Circi, M.-H. Chiu, N. Daelman, M.L. Evans, A.S. Gangan, J. George, H. Harb, G. Khalighinejad, S.T. Khan, S. Klawohn, M. Lederbauer, S. Mahjoubi, B. Mohr, S.M. Moosavi, A. Naik, A.B. Ozhan, D. Plessers, A. Roy, F. Schöppach, P. Schwaller, C. Terboven, K. Ueltzen, S. Zhu, \Me, C. Li, I. Foster, B. Blaiszik. 32 examples of LLM applications in materials science and chemistry: towards automation, assistants, agents, and accelerated scientific discovery. \emph{Machine Learning: Science and Technology}.
...
\Year{2023}  &
  ...
  \DOI{10.1038/s41467-023-38169-2}. Citations:~50
  ...
  \DOI{10.21105/joss.05118}. Citations:~62
...
\Year{2021}  &
  ...
  \DOI{10.1016/j.commatsci.2020.110065}. Citations:~49
...
\Year{2020}  &
  ...
  \DOI{10.1103/PhysRevB.102.100101}. Citations:~9
...
\Year{2019}  &
  ...
  \emph{Computational Materials Science}.
  \DOI{10.1016/j.commatsci.2018.07.043}. Citations:~176
  ...
  \DOI{10.1088/1361-651X/aafd13}. Citations:~27
  \\
\Year{2016}  &
...
\Year{2025}  &
  ...
  Citations:~18
  \GitHub{BattModels/material\_agent}
\end{EntriesTable}
...
\begin{EntriesTable}
  ...
  \newline • Contribution: over $1000$ packages with a total of over $500$ million downloads
...
%\Year{future}  &
\Year{2025} &
  \textbf{Shared lecture with Prof. G. Sutmann} on ``Programming Concepts in Materials Science`` for master students in materials science and simulation.
  \textit{Ruhr University Bochum}, Bochum, Germany.
  \\
  ~ &
  \textbf{Single lecture} on ``From Atoms to Material Properties: An introduction to ab-initio thermodynamics`` as part of the lecture on ``Materials Modelling`` for master students in materials science.
  \textit{Birmingham University}, Birmingham, United Kingdom. 
  \\
  ~ &
  \textbf{Single lecture} on ``Extension of Density Functional Theory: From Molecules to Solids`` as part of the lecture on ``Molecular Photonics and Excited-State Processes (MPESP)`` for master students in chemistry.
  \textit{Heinrich Heine University}, D\"usseldorf, Germany.
  \\
\Year{2024} &
  \textbf{Single lecture} on ``Density Functional Theory`` as part of the International Max Planck Research School for Sustainable Metallurgy lecture series on Thermodynamics.
  \textit{Max Planck Institute for Sustainable Materials}, D\"usseldorf, Germany
  \\
\Year{2023} &
  \textbf{Single lecture} on ``Introduction to Materials Informatics`` as part of the Graduate Autumn School of the CRC1349.
...
\Duration{2024}{\Ongoing} &
  ...
  \\
  ~ &
  \textbf{Ziqi Wang} (PhD student): Autonomous discovery of novel battery materials with large language model agents and machine-learned interatomic potentials.
  \Role{Co-Supervisor - in collaboration with Prof. Viswanathan at University of Michigan}
  \\
\Duration{2023}{\Ongoing} &
...
\Year{2026}  &
  \Me.
  Scalable sustainable materials design with the pyiron workflow framework, \emph{NERSC}, Berkeley, Ca, USA.
  \\
  ~ &
  \Me.
  Autonomous, Data-Driven Workflows for Materials Acceleration Platforms with pyiron, \emph{DPG Spring Meeting}, Dresden, Germany.
  \\
  ~ &
  \Me. 
  Up-scaling Python functions for HPC with executorlib, \emph{Workflows Community Talks},
  Chicago, Il, USA (online).
  \\
\Year{2025}  &
  \Me.
  Autonomous Materials Science Research,
  \emph{European Space Agency AI STAR Symposium},
  Darmstadt, Germany.
  \\
  ~ &
  \Me.
  Can a machine predict novel sustainable materials? Towards using LLMs for Materials Design,
  \emph{Birmingham University},
  Birmingham, United Kingdom.
  \\
  ~ &
  \Me.
  Autonomous Materials Science Research,
  \emph{German Research Centre for Artificial Intelligence},
  Saarbrücken, Germany.
  \\
  ~ &
  \Me.
...
\begin{EntriesTable}
\Year{2026}  &
  T. Hickel, {\Me} and J. Neugebauer.
  Data-Driven and LLM-Based Design of Hydrogen Solubilities in Metallic Alloys, \emph{TMS Spring Meeting}, San Diego, Ca, USA.
  \\
  ~ &
  {\Me} and J. Neugebauer.
  Large Language Model Agents for Atomistic Simulation Workflows, \emph{TMS Spring Meeting}, San Diego, Ca, USA.
  \\
  ~ &
  \Me, P. Chilakalapudi, H. Gaafer and J. Neugebauer. 
  Uncertainty Propagation for Ab Initio Thermodynamic Phase Diagrams, \emph{TMS Spring Meeting}, San Diego, Ca, USA.
  \\
  ~ &
  H. L. Mai, \Me, T. Hickel and J. Neugebauer. 
  Accelerating grain boundary segregation studies in ferritic steels with machine learned interatomic potentials,
  \emph{DPG Spring Meeting},
  Dresden, Germany.
  \\
  ~ &
  \Me. 
  Leveraging AI in Simulation Workflows for Sustainable Materials Design with pyiron, 
  \emph{deRSE Conference}, 
  Stuttgart, Germany.
  \\
\Year{2025}  &
  \Me.
  Up-scaling Python functions for HPC with executorlib,
  \emph{Supercomputing Conference},
  St. Louis, MO, USA.
  \\
  ~ &
  {\Me} and \JN.
  Automated Workflows for Fitting Machine Learned Interatomic Potentials on the Exascale with pyiron,
  \emph{Psi-k conference},
